...
type ServerConfig struct {
	...
	// Authentication type
	AuthType AuthType `protobuf:"varint,5,opt,name=auth_type,json=authType,proto3,enum=xray.proxy.http.AuthType" json:"auth_type,omitempty"`
	// Key map for KEYAUTH
	Keys          map[string]int32 `protobuf:"bytes,6,rep,name=keys,proto3" json:"keys,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServerConfig) GetKeys() map[string]int32 {
	if x != nil {
		return x.Keys
	}
	return nil
...
const file_proxy_http_config_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\x8e\x03\n" +
	"\fServerConfig\x12G\n" +
	...
	"\n" +
	"user_level\x18\x04 \x01(\rR\tuserLevel\x126\n" +
	"\tauth_type\x18\x05 \x01(\x0e2\x19.xray.proxy.http.AuthTypeR\bauthType\x12;\n" +
	"\x04keys\x18\x06 \x03(\v2'.xray.proxy.http.ServerConfig.KeysEntryR\x04keys\x1a;\n" +
	...
	"\x06header\x18\x02 \x03(\v2\x17.xray.proxy.http.HeaderR\x06header*2\n" +
	"\bAuthType\x12\v\n" +
...
var file_proxy_http_config_proto_goTypes = []any{
	(AuthType)(0),                   // 0: xray.proxy.http.AuthType
	...
	nil,                             // 6: xray.proxy.http.ServerConfig.KeysEntry
...
var file_proxy_http_config_proto_depIdxs = []int32{
	...
	0, // 1: xray.proxy.http.ServerConfig.auth_type:type_name -> xray.proxy.http.AuthType
	6, // 2: xray.proxy.http.ServerConfig.keys:type_name -> xray.proxy.http.ServerConfig.KeysEntry
	7, // 3: xray.proxy.http.ClientConfig.server:type_name -> xray.common.protocol.ServerEndpoint
	3, // 4: xray.proxy.http.ClientConfig.header:type_name -> xray.proxy.http.Header
