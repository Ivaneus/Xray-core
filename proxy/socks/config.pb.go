...
const (
	...
	// KEYAUTH is for key-based authentication.
...
type ServerConfig struct {
	...
	// Key map for KEYAUTH
	Keys          map[string]int32 `protobuf:"bytes,7,rep,name=keys,proto3" json:"keys,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proxy_socks_config_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xbc\x03\n" +
	"\fServerConfig\x127\n" +
	...
	"\x04keys\x18\a \x03(\v2(.xray.proxy.socks.ServerConfig.KeysEntryR\x04keys\x1a;\n" +
	...
	"\fClientConfig\x12<\n" +
	"\x06server\x18\x01 \x03(\v2$.xray.common.protocol.ServerEndpointR\x06server*2\n" +
	"\bAuthType\x12\v\n" +
...
var file_proxy_socks_config_proto_goTypes = []any{
	...
	nil,                             // 5: xray.proxy.socks.ServerConfig.KeysEntry
...
var file_proxy_socks_config_proto_depIdxs = []int32{
	...
	5, // 3: xray.proxy.socks.ServerConfig.keys:type_name -> xray.proxy.socks.ServerConfig.KeysEntry
